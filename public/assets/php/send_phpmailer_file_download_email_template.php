...
if (! $errors) {
    ...
    try {
        ...
        // Set HTML content
        $body = str_replace(
            ['customerName', 'customerEmail', 'customerPhone', 'customerSubject', 'uploadedFile', 'customerMessage'],
            [$customer_name, $customer_mail, $customer_phone, $customer_subject, $uploaded_file, $customer_message], $email_html);
