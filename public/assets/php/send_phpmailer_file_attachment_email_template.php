...
if (! $errors) {
    ...
    try {
        ...
        // Set HTML content
        $body = str_replace(
            ['customerName', 'customerEmail', 'customerPhone', 'customerSubject', 'fileAttachment', 'customerMessage'],
            [$customer_name, $customer_mail, $customer_phone, $customer_subject, $file_attachment, $customer_message], $email_html);
        ...
        // Set HTML content
        $body = str_replace(['customerName'], [$customer_name], $email_confirmation_html);
        $mail->MsgHTML($body);
